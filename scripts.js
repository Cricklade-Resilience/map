...
//      url: 'https://services.arcgis.com/V6ZHFr6zdgNZuVG0/arcgis/rest/services/UK_Parliamentary_Constituencies_2024/FeatureServer/0',
//    }).addTo(map);
...
function createOnEachFeature(name, icon, label) {
  ...
  if (name === "Admin: Warden Zones") {
    ...
    style = { color: "red", weight: 2, fillOpacity: 0.1 };  // ✅ red fill/outline
  }
